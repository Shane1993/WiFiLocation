...
public class ResetLoginPassword {
    ...
    public ResetLoginPassword(final Context context, String userName, String password, String newPassword, final SuccessCallback successCallback, final FailCallback failCallback)
    {
        new NetConnection(context, Config.KEY_CLOUD_CODE_NAME, new NetConnection.SuccessCallback() {
            ...
            public void onFail(String failResult) {
                ...
                Config.KEY_REQUEST_BODY_NAME,Config.ACTION_RESET_LOGIN_PASSWORD,
                Config.KEY_REQUEST_BODY_USERNAME,userName,
                Config.KEY_REQUEST_BODY_PASSWORD,password,
                Config.KEY_REQUEST_BODY_NEWLOGINPASSWORD,newPassword);
